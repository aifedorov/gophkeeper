...
// Source: internal/server/domain/auth/repository/db/repository.go
//
// Generated by this command:
//
//	mockgen -source=internal/server/domain/auth/repository/db/repository.go -destination=internal/server/domain/auth/repository/db/mocks/mock_repository.go -package=mocks
//
